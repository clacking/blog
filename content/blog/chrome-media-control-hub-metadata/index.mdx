...
update: "2020-01-10T08:38:01.880Z"
...
navigator.mediaSession.metadata = new MediaMetadata({
	...
	artwork: [
		{ src: 'https://sample.com/test.jpg', sizes: '256x256', type: 'image/png' },
	]
})
</script>
</html>
...
これでYoutube見たいに情報を表示できます。もっと細かく情報やハンドラを付けたい場合はスマホ版の話ですが、
[Google](https://developers.google.com/web/updates/2017/02/media-session?hl=ja)の解説を読みましょう。

私見たいにタブをバカみたいに開く人には良い機能かもしれませんが、邪魔だという人は `chrome://flags/#global-media-controls` から無効化できるみたいです。
