...
<video src='/static/autopy-085487db69dfb014e421436f82cc4597.webm' style="width: 100%" controls autoplay loop />

フォーム一つを入力すると自動で次のフォームへ移動する為、マウス移動は一度で済みます。

<video src='/static/unbox-2a29b8ff78f7992d68af36d4db5a7427.webm' style="width: 100%" controls autoplay loop />
